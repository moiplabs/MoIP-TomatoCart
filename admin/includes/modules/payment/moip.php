 ...
 */
    ...
    function install() {
	  ...
	  $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value,  configuration_description, configuration_group_id, sort_order,  set_function, date_added) values ('Banner ', 'MODULE_PAYMENT_MOIP_BANNER', 'http://www.moip.com.br/imgs/banner_5_1.gif',  'Você pode escolher a dimensão do banner exibido para seu cliente.<br>Ex: Tamanho X Largura', '6', '".$sort_order++."',  'tep_cfg_select_option(array(\'http://www.moip.com.br/img/banner/160x260.gif\', \'http://www.moip.com.br/img/banner/300x250.gif\', \'http://www.moip.com.br/img/banner/728x90.gif\', \'http://www.moip.com.br/imgs/banner_5_1.gif\', \'PROPRIO\'), ', now())");
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value,  configuration_description, configuration_group_id, sort_order,  set_function, date_added) values ('Calculo de frete pelo MoIP ?', 'MODULE_PAYMENT_MOIP_FRETE', 'NAO',  'Você deseja que o MoIP calcule seu frete?<br>Caso seja \"NAO\" o módulo ira pegar o valor de frete gerado pelo OsCommerce. <br>Somente marque como SIM se você não tiver calculo de frete em sua loja.', '6', '".$sort_order++."',  'tep_cfg_select_option(array(\'SIM\', \'NAO\'), ', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value,  configuration_description, configuration_group_id, sort_order,  set_function, date_added) values ('API - Habilitar Pagamento Direto', 'MODULE_PAYMENT_MOIP_XML_PAGAMENTO_DIRETO', 'NAO',  'Pagamento Direto para Boleto(É necessario que essa ferramenta esteja habilitada em sua conta MoIP através da central de atendimento.)', '6', '".$sort_order++."',  'tep_cfg_select_option(array(\'SIM\', \'NAO\'), ', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value,  configuration_description, configuration_group_id, sort_order,  use_function, set_function, date_added ) values ( 'Status de Falha', 'MODULE_PAYMENT_MOIP_ORDER_STATUS_ID', '8',  'Atualiza o status dos pedidos efetuados por este módulo de pagamento quando ocorre falha no pagamento.(Ex: Falha no pagamento MoIP), ', '6', '".$sort_order++."',  'tep_get_order_status_name', 'tep_cfg_pull_down_order_statuses(', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value,  configuration_description, configuration_group_id, sort_order,  use_function, set_function, date_added ) values ( 'Status MoIP - Autorizado (Pago)', 'MODULE_PAYMENT_MOIP_STATUS_1', '1',  'Pagamento já foi realizado porém ainda não foi creditado na Carteira MoIP recebedora (devido ao floating da forma de pagamento)', '6', '".$sort_order++."',  'tep_get_order_status_name', 'tep_cfg_pull_down_order_statuses(', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value,  configuration_description, configuration_group_id, sort_order,  use_function, set_function, date_added ) values ( 'Status MoIP - Iniciado', 'MODULE_PAYMENT_MOIP_STATUS_2', '2',  'Pagamento está sendo realizado ou janela do navegador foi fechada (pagamento abandonado)', '6', '".$sort_order++."',  'tep_get_order_status_name', 'tep_cfg_pull_down_order_statuses(', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value,  configuration_description, configuration_group_id, sort_order,  use_function, set_function, date_added ) values ( 'Status MoIP - Boleto Impresso', 'MODULE_PAYMENT_MOIP_STATUS_3', '3',  'Boleto foi impresso e ainda não foi pago', '6', '".$sort_order++."',  'tep_get_order_status_name', 'tep_cfg_pull_down_order_statuses(', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value,  configuration_description, configuration_group_id, sort_order,  use_function, set_function, date_added ) values ( 'Status MoIP - Concluido', 'MODULE_PAYMENT_MOIP_STATUS_4', '4',  'Pagamento já foi realizado e dinheiro já foi creditado na Carteira MoIP recebedora', '6', '".$sort_order++."',  'tep_get_order_status_name', 'tep_cfg_pull_down_order_statuses(', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value,  configuration_description, configuration_group_id, sort_order,  use_function, set_function, date_added ) values ( 'Status MoIP - Cancelado', 'MODULE_PAYMENT_MOIP_STATUS_5', '5',  'Pagamento foi cancelado pelo pagador, instituição de pagamento, MoIP ou recebedor antes de ser concluído', '6', '".$sort_order++."',  'tep_get_order_status_name', 'tep_cfg_pull_down_order_statuses(', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value,  configuration_description, configuration_group_id, sort_order,  use_function, set_function, date_added ) values ( 'Status MoIP - Em análise ', 'MODULE_PAYMENT_MOIP_STATUS_6', '6',  'Pagamento foi realizado com cartão de crédito e autorizado, porém está em análise pela Equipe MoIP. Não existe garantia de que será concluído', '6', '".$sort_order++."',  'tep_get_order_status_name', 'tep_cfg_pull_down_order_statuses(', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value,  configuration_description, configuration_group_id, sort_order,  use_function, set_function, date_added ) values ( 'Status MoIP - Estornado', 'MODULE_PAYMENT_MOIP_STATUS_7', '7',  'Pagamento foi estornado pelo pagador, recebedor, instituição de pagamento ou MoIP', '6', '".$sort_order++."',  'tep_get_order_status_name', 'tep_cfg_pull_down_order_statuses(', now())");
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value,  configuration_description, configuration_group_id, sort_order,  use_function, set_function, date_added ) values ( 'Zonas suportadas', 'MODULE_PAYMENT_MOIP_ZONE', '0',  'Se uma zona for selecionada, este meio de pagamento estará disponível somente para esta zona.', '6', '".$sort_order++."',  'tep_get_zone_class_title', 'tep_cfg_pull_down_zone_classes(', now())");
